...
if ($res === "notyet") {
  ...
  /*
The file parameters.php contains MYSQL table name for this site
*/
...
2. repeat: old user, logging in to the system again, with their record existing in the DB

Login flow for each type of user:

1: new : index.php -> verify.php -> result.php -> verify_pass.php (or verify_fail.php) -> login_success.php -> uam_handle_form.php -> thankyou.htm
2. repeat : index.php -> welcome.php -> uam_handle_form.php -> thankyou.htm
*/
...
?>
  ...
  <body>
    <div class="bg">
      ...
      <div id="customers" class="content is-size-6">Get your customers to keep coming back!</div>
