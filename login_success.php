...
<body>
  <div class="bg_loginsuccess">
          ...
          <div class="control">
            <label class="checkbox">
              <div class="terms">
                ...
                I agree to the <a id="modal-link" href="#modal-link">Terms and Privacy Policy</a>
              </div>
            </label>
          </div>
        </div>
    ...
    <div id="powered_loginsuccess" class="content is-size-6">Powered by Zigsa</div>
