...
<body>
  <div class="bg">
    ...
    <form id="login_success" class="zigsawifi_form" method="post" action="result.php" onsubmit="return codeCheck()">
    ...
    <div id="powered_verify" class="content is-size-6">Powered by Zigsa</div>
